...
import PIL
bg = img.resize((w, h), PIL.Image.Resampling.LANCZOS)
...
button5 = tk.Button(root, command=Video_Verify, text="Fall Detection",
                    width=20, font=("Tempus Sanc ITC", 15), bg="cyan", fg="black")
